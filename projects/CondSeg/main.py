...
from condseg.trainer import TrainerCondSeg
from condseg.config import add_condseg_config



def main():
    args = get_args()
    cfg = load_cfg(args, freeze=False, add_cfg_func=add_condseg_config)
    ...
    trainer = TrainerCondSeg(cfg, device, mode,
