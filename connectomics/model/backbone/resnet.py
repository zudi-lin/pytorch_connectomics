...
from ..block import BasicBlock3d, BasicBlock3dSE, conv3d_norm_act
...
# 2D ResNet
# ---------------------------
# The 2D ResNet model is adapted from:
# https://raw.githubusercontent.com/pytorch/vision/master/torchvision/models/resnet.py
# commit 8e878f0fa992a5e42ea5e38813b533eb4a551db2 (Nov 16, 2020)
...
def conv3x3(in_planes: int, out_planes: int, stride: int = 1, groups: int = 1,
            dilation: int = 1, pad_mode: str = 'replicate') -> nn.Conv2d:
    ...
    def _make_layer(self, block: Type[Union[BasicBlock, Bottleneck]], planes: int, blocks: int,
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                get_norm_2d(norm_mode, planes * block.expansion),
            )

        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, self.groups,
                            self.base_width, previous_dilation, **self.shared_kwargs))
...
def resnet18(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
...
def resnet34(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
...
def resnet50(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
...
def resnet101(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
...
def resnet152(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
...
def resnext50_32x4d(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
...
def resnext101_32x8d(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
...
def wide_resnet50_2(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
...
def wide_resnet101_2(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet2D:
